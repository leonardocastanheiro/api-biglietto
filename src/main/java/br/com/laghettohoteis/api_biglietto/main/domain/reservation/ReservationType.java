...
public class ReservationType implements Comparable<ReservationType> {
    ...
    public ReservationType(String code, String description, Hotel hotel) {
        this.code = code;
    ...
    @Override
    public int compareTo(ReservationType o) {
        return this.getId().toLowerCase().compareTo(o.getId().toLowerCase());
    }
}
